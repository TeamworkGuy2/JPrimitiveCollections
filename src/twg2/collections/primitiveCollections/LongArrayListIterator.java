 ...
 * This class is not thread safe, because the {@code LongArrayList} passed to the constructor is not copied.
...
public class LongArrayListIterator implements LongIterator {
	private volatile int modCached = 0;
	private LongArrayList col;
	private int off;
	private int size;
	private int index;


	public LongArrayListIterator(LongArrayList col) {
	 ...
	 */
	public LongArrayListIterator(LongArrayList col, int off, int len, int offStartIndex) {
