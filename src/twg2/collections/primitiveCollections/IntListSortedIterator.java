...
public class IntListSortedIterator implements IntIterator {
	private volatile int modCached = 0;
	private IntListSorted col;
	private int off;
	private int size;
	private int index;


	public IntListSortedIterator(IntListSorted col) {
	 ...
	 */
	public IntListSortedIterator(IntListSorted col, int off, int len, int offStartIndex) {
