...
public class CharMapSorted<T> implements CharMapReadOnly<T>, RandomAccess {
	 ...
	 */
	@Override
	public int lastIndexOfKey(char key) {
		int idx = Arrays.binarySearch(keys, 0, size, key);
		return idx > -1 ? idx : -1;
	}
	...
	public final void putAll(Iterable<? extends Character> keys, Iterable<? extends T> values) {
