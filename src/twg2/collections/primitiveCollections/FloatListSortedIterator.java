 ...
 * This class is not thread safe, because the {@code FloatListSorted} passed to the constructor is not copied.
...
public class FloatListSortedIterator implements FloatIterator {
	private volatile int modCached = 0;
	private FloatListSorted col;
	private int off;
	private int size;
	private int index;


	public FloatListSortedIterator(FloatListSorted col) {
	 ...
	 */
	public FloatListSortedIterator(FloatListSorted col, int off, int len, int offStartIndex) {
