 ...
 * This class is not thread safe, because the {@code LongListSorted} passed to the constructor is not copied.
...
public class LongListSortedIterator implements LongIterator {
	private volatile int modCached = 0;
	private LongListSorted col;
	private int off;
	private int size;
	private int index;


	public LongListSortedIterator(LongListSorted col) {
	 ...
	 */
	public LongListSortedIterator(LongListSorted col, int off, int len, int offStartIndex) {
