 ...
 * This class is not thread safe, because the {@code IntArrayList} passed to the constructor is not copied.
...
public class IntArrayListIterator implements IntIterator {
	...
	private IntArrayList col;
	private int off;
	private int size;
	private int index;


	public IntArrayListIterator(IntArrayList col) {
