 ...
 * This class is not thread safe, because the {@code char[]} passed to the constructor is not copied.
...
public class CharArrayIterator implements CharIterator {
	private int mod = 0;
	...
	public CharArrayIterator(char[] col, int offStartIndex) {
	 ...
	 */
	public CharArrayIterator(char[] col, int off, int len, int offStartIndex) {
		this.col = col;
		this.off = off;
		this.size = off + len;
